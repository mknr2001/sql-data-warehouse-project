...
Actions Performed:
    - Checks for null/duplicate primary keys.
    - Identifies unwanted spaces in string fields.
    - Validates data standardization and consistency.
    - Detects invalid date ranges and relationships.
