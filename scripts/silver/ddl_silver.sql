...
===============================================================================
Script Purpose:
    This script creates tables in the 'silver' schema (database), dropping 
    existing tables if they already exist.

    - Recreates all Silver layer tables.
    - Adds dwh_create_date column with default current timestamp.

    Run this script whenever you need to reset and redefine the Silver layer.
===============================================================================
*/
